...
\begin{figure}[h!]
    ...
    \caption{Autocorrelation plots for $\beta$, $\gamma$, $\sigma$ and $\mu$}
...
\textbf{Geweke diagnostic}: With the dynamic version of the Geweke diagnostic, the Z-values for $\beta$, $\gamma$, $\sigma$, $\mu$ and $\pi_{iag}$ in all chains (except $\sigma$ in chain 1) fell inside the [-1.96, 1.96] interval indicating stationarity. The Geweke diagnostic plots are shown in figure \ref{fig:gewekem2}. 
